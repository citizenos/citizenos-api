...
module.exports = {
    up: (queryInterface, Sequelize) => {
        ...
        return queryInterface.createTable('TopicReport', {
            id: {
                type: Sequelize.UUID,
                primaryKey: true,
                allowNull: false,
        ...
        return queryInterface
            ...
            .then(function () { // While Sequelize does not support naming ENUMS, it creates duplicates - https://github.com/sequelize/sequelize/issues/2577
                return queryInterface.sequelize
                    .query('DROP TYPE "enum_TopicReports_moderatedReasonType";');
            })
            .then(function () {
                return queryInterface.sequelize
                    .query('DROP TYPE "enum_TopicReports_type";');
            });
    }
};

...
suite('cosEtherpad', function () {
    ...
    suite('getUserAccessUrl', function () {
        ...
        test('Success', function (done) {
            ...
            var parsedUrl = url.parse(cosEtherpad.getUserAccessUrl(topic, user.id, user.name, user.language), true);
            assert.equal(topic.padUrl, parsedUrl.protocol + '//' + parsedUrl.host + parsedUrl.pathname);
            assert.equal(user.language, parsedUrl.query.lang);

            var jwtPayload = jwt.decode(parsedUrl.query.jwt);
    ...
    suite('getTopicPadUrl', function () {
        ...
        test('Success', function (done) {
            ...
            var padUrl = cosEtherpad.getTopicPadUrl(topicId);
    ...
    suite('getTopicTitleFromPadContent', function () {
        ...
        test('Success - single short line', function (done) {

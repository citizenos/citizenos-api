                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td  align="center" valign="middle" style="background-color: #FFFFFF;border-bottom: 1px solid #f0f0f0;" height="80">
                                                            <p style="font-family: georgia, serif;font-size:19px; font-weight:bold;background-color: #FFFFFF; color:#252525;">{{{REPORT_COMMENT_CREATOR.TITLE}}}</p>
                                                        </td>
                                                    </tr>

                                                    <tr>
                                                        <td  align="center" valign="middle" style="background-color: #FFFFFF;border-bottom: 1px solid #f0f0f0;" height="80">
                                                            <p style="font-family: georgia, serif;font-size:17px; font-weight:bold;background-color: #FFFFFF; color:#252525;">{{{REPORT_COMMENT_CREATOR.SECTION_COMMENT.TITLE}}}</p>
                                                            {{{REPORT_COMMENT_CREATOR.SECTION_COMMENT.COMMENT_SUBJECT}}}
                                                            <p style="font-family: georgia, serif;font-size:17px; font-weight:bold;background-color: #FFFFFF; color:#707070; font-style: italic">{{{REPORT_COMMENT_CREATOR.SECTION_COMMENT.COMMENT_TEXT}}}</p>
                                                        </td>
                                                    </tr>

                                                    <tr>
                                                        <td  align="center" valign="middle" style="background-color: #FFFFFF;border-bottom: 1px solid #f0f0f0;" height="80">
                                                            <p style="font-family: georgia, serif;font-size:17px; font-weight:bold;background-color: #FFFFFF; color:#252525;">{{{REPORT_COMMENT_CREATOR.SECTION_REPORT.TITLE}}}</p>
                                                            <p style="font-family: georgia, serif;font-size:17px; font-weight:bold;background-color: #FFFFFF; color:#252525; font-style: italic">{{{REPORT_COMMENT_CREATOR.SECTION_REPORT.REPORT_TYPE}}}</p>
                                                            {{{REPORT_COMMENT_CREATOR.SECTION_REPORT.REPORT_TEXT}}}
                                                        </td>
                                                    </tr>

                                                    <tr>
                                                        <td  align="center" valign="middle" style="background-color: #FFFFFF;border-bottom: 1px solid #f0f0f0;" height="80">
                                                            <p style="font-family: georgia, serif;font-size:17px; font-weight:bold;background-color: #FFFFFF; color:#252525;">{{{REPORT_COMMENT_CREATOR.SECTION_ACTIONS.TITLE}}}</p>
                                                            <ul>
                                                                <li style="font-family: georgia, serif;font-size:17px; font-weight: bold; font-style: italic ;background-color: #FFFFFF; color:#0680fc; margin-bottom: 17px;">{{{REPORT_COMMENT_CREATOR.SECTION_ACTIONS.EDIT_OR_DELETE}}}</li>

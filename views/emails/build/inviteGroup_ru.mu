                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                     ...
                                                     <tr>
                                                        <td  align="center" valign="middle" style="background-color: #FFFFFF;border-bottom: 1px solid #f0f0f0; border-top: 1px solid #fbfbfb; " height="130">
                                                            <p style="font-family: arial, helvetica, sans-serif;font-size:14px;background-color: #FFFFFF; color:#252525;">CitizenOS user <b>{{fromUser.name}}</b> just invited you to join a decision-making group:</p>
                                                    ...
                                                    <tr>
                                                        <td  align="left" valign="bottom" style="background-color: #FFFFFF;border-top: 1px solid #fbfbfb;" height="120">
                                                            <p style="font-family: arial, helvetica, sans-serif;font-size:14px;background-color: #FFFFFF; color:#252525;">We hope you make many excellent decisions together!</p>

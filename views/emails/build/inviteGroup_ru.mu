                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td  align="center" valign="middle" style="background-color: #FFFFFF;border-bottom: 1px solid #f0f0f0;" height="80">
                                                            <p style="font-family: georgia, serif;font-size:19px; font-weight:bold;background-color: #FFFFFF; color:#252525;">Здравствуйте, {{toUser.name}}!</p>
                                                        </td>
                                                    </tr>
                                                     ...
                                                     <tr>
                                                        <td  align="center" valign="middle" style="background-color: #FFFFFF;border-bottom: 1px solid #f0f0f0; border-top: 1px solid #fbfbfb; " height="130">
                                                            <p style="font-family: arial, helvetica, sans-serif;font-size:14px;background-color: #FFFFFF; color:#252525;">Пользователь CitizenOS <b>{{fromUser.name}}</b> приглашает Вас присоединиться к группе принимающих решение:</p>
                                                            <p style="font-family: georgia, serif;font-size:18px; font-weight: bold; font-style: italic ;background-color: #FFFFFF; color:#0680fc;"><a href="{{linkViewGroup}}" target="_blank">{{group.name}}</a></p>
                                                        </td>
                                                    </tr>

                                                    <tr>
                                                        <td  align="left" valign="bottom" style="background-color: #FFFFFF;border-top: 1px solid #fbfbfb;" height="120">
                                                            <p style="font-family: arial, helvetica, sans-serif;font-size:14px;background-color: #FFFFFF; color:#252525;">Желаем Вам наилучших совместных решений!</p>
                                                            <p style="font-family: arial, helvetica, sans-serif;font-size:14px;background-color: #FFFFFF; color:#252525;">Команда CitizenOS</p>
                                                        </td>
                                                    </tr>

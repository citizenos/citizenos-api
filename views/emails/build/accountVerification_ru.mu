                                                    ...
                                                    <tr>
                                                     ...
                                                     <tr>
                                                        <td  align="center" valign="middle" style="background-color: #FFFFFF;border-bottom: 1px solid #f0f0f0; border-top: 1px solid #fbfbfb; " height="130">
                                                            <p style="font-family: arial, helvetica, sans-serif;font-size:14px;background-color: #FFFFFF; color:#252525;">Чтобы активировать свой аккаунт, необходимо подтвердить свой e-mail. Сделайте это, пройдя по ссылке ниже.</p>
                                                            <p style="font-family: georgia, serif;font-size:18px; font-weight: bold; font-style: italic ;background-color: #FFFFFF; color:#0680fc;"><a href="{{linkVerify}}" target="_blank"> Подтвердите e-mail</a></p>
                                                        </td>
                                                    </tr>

                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td  align="center" valign="middle" style="background-color: #FFFFFF;border-bottom: 1px solid #f0f0f0;" height="80">
                                                            <p style="font-family: georgia, serif;font-size:19px; font-weight:bold;background-color: #FFFFFF; color:#252525;">Sinu kommentaar on märgitud ebasobivaks</p>
                                                        </td>
                                                    </tr>

                                                    <tr>
                                                        <td  align="center" valign="middle" style="background-color: #FFFFFF;border-bottom: 1px solid #f0f0f0;" height="80">
                                                            <p style="font-family: georgia, serif;font-size:17px; font-weight:bold;background-color: #FFFFFF; color:#252525;">Kirjutasid:</p>
                                                            {{#comment.subject}}
...
{{/report.text}}
                                                    ...
                                                    <tr>
                                                        <td  align="center" valign="middle" style="background-color: #FFFFFF;border-bottom: 1px solid #f0f0f0;" height="80">
                                                            ...
                                                            <ul>
                                                                <li style="font-family: georgia, serif;font-size:17px; font-weight: bold; font-style: italic ;background-color: #FFFFFF; color:#0680fc; margin-bottom: 17px;"><a href="{{linkViewTopic}}">Muuta või kustutada oma kommentaari</a></li>

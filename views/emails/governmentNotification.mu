    ...
    <tr>
        <td align="center" valign="top" >
            <table border="0" cellpadding="0" cellspacing="0" id="templateContainer" style="background-color: #FFFFFF;margin: 0;padding: 0;" width="600">
                <tbody>
                    <tr>
                        <td align="center" valign="middle" style="background-color: #004892; border-bottom: 1px solid #e1e1e1; " height="100">
                            <img width="360" height="51" src="cid:logo" alt="logo" style="display:block;"  border="0"/>
                        </td>
                    </tr>
                                        ...
                                        <table border="0" cellpadding="10" cellspacing="0" width="100%">
                                            ...
                                            <tr>
                                                <td align="center" valign="middle" style="background-color: #FFFFFF;border-bottom: 1px solid #f0f0f0;" height="80">
                                                    <p style="font-family: georgia, serif;font-size:19px; font-weight:bold;background-color: #FFFFFF; color:#252525;">{{{GOVERNMENT_NOTIFICATION.TITLE}}}</p>
                                            ...
                                            <tr>
                                                <td align="center" valign="middle" style="background-color: #FFFFFF;border-bottom: 1px solid #f0f0f0; border-top: 1px solid #fbfbfb; " height="130">
                                                    <p style="font-family: arial, helvetica, sans-serif;font-size:14px;background-color: #FFFFFF; color:#252525;">
                                                        {{{GOVERNMENT_NOTIFICATION.HEADING}}}
                                                    </p>

                                                    <p style="font-family: arial, helvetica, sans-serif;font-size:14px;background-color: #FFFFFF; color:#252525;">
                                                        {{{GOVERNMENT_NOTIFICATION.HEADING_SENDERS_REFERENCE}}}
                                                    </p>

                                                    <p style="font-family: arial, helvetica, sans-serif;font-size:14px;background-color: #FFFFFF; color:#252525; font-weight: bold;">
                                                        {{{GOVERNMENT_NOTIFICATION.TXT_SENDERS_REFERENCE}}}
                                                    </p>

                                                    <p style="font-family: arial, helvetica, sans-serif;font-size:14px;background-color: #FFFFFF; color:#252525;">
                                                        {{{GOVERNMENT_NOTIFICATION.HEADING_CONTACT}}}
                                                    </p>

                                                    <p style="font-family: arial, helvetica, sans-serif;font-size:14px;background-color: #FFFFFF; color:#252525; font-weight: bold;">
                                                        {{{GOVERNMENT_NOTIFICATION.CONTACT_INFO}}}
                                                    </p>

                                                    <p style="font-family: arial, helvetica, sans-serif;font-size:14px;background-color: #FFFFFF; color:#252525;">
                                                        {{{GOVERNMENT_NOTIFICATION.BDOC_DOWNLOAD_NOTIFICATION}}}
                                                    </p>

                                                    <p>
                                                        {{{GOVERNMENT_NOTIFICATION.BDOC_DOWNLOAD_LINK}}}
                                                    </p>

                                                    <p style="font-family: arial, helvetica, sans-serif;font-size:14px;background-color: #FFFFFF; color:#252525; text-align: left;">
                                                        {{{GOVERNMENT_NOTIFICATION.BDOC_DOWNLOAD_EXPLANATION}}}
                                                    </p>

                                                    <p style="font-family: arial, helvetica, sans-serif;font-size:14px;background-color: #FFFFFF;color:#252525; text-align: left;">
                                                        {{{GOVERNMENT_NOTIFICATION.HEADING_CONTAINER_CONTENTS}}}
                                                    </p>
                                                    <ul style="font-family: arial, helvetica, sans-serif;font-size:14px;background-color: #FFFFFF; color:#252525; text-align: left;">
                                                        {{{GOVERNMENT_NOTIFICATION.CONTAINER_CONTENTS}}}
                                                    </ul>
                                                    <p>
                                                        {{{GOVERNMENT_NOTIFICATION.ADD_EVENT_LINK}}}
                                                    </p>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td align="left" valign="bottom" style="background-color: #FFFFFF;border-top: 1px solid #fbfbfb;" height="120">
                                                    <p style="font-family: arial, helvetica, sans-serif;font-size:14px;background-color: #FFFFFF; color:#252525;">
                                                        {{{GOVERNMENT_NOTIFICATION.FOOTER_GREETINGS}}}
                                                    </p>
                                                    <p style="font-family: arial, helvetica, sans-serif;font-size:14px;background-color: #FFFFFF; color:#252525;">
                                                        {{{GOVERNMENT_NOTIFICATION.FOOTER_CONTACT_INFO_RAA}}}
                                                    </p>
                                                </td>
                                            </tr>
        ...
        <td align="center" valign="top"  height="70">
            <table border="0" cellpadding="0" cellspacing="0" id="templateFooter" style="background-color: #f6f6f6;margin: 0;padding: 0;" width="600">
                <tbody>
                    <tr>
                        <td align="center" height="70" style="border-collapse: collapse" valign="middle">
                            <p style="font-family: arial, helvetica, sans-serif;font-size:12px;background-color: #f6f6f6; color:#828282;">{{{GENERAL.FOOTER_RAA}}}</p>
                        </td>
                    </tr>
                </tbody>
            </table>

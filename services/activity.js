...
module.exports = function (app) {
    ...
    const userUnreadActivitiesCount = async function (req, res, next) {
        const userId = req.user.userId;
    ...
    return {
        activitiesDataFunction,
        buildActivityFeedIncludeString,
        parseActivitiesResults,
        topicActivitiesList,
        topicUnreadActivitiesCount,
        activitiesList,
        userUnreadActivitiesCount,
        groupActivitiesList,
        groupUnreadActivitiesCount
    };
};